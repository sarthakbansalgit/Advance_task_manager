...
<div class="container">
    ...
    <form action="display_searched_tasks.php" method="get">
        <label for="search">Search Task:</label>
        <input type="text" id="search" name="search" placeholder="Enter task or tag">
        <button type="submit" name="search_submit">Search</button>
    </form>

    <hr>

    <!-- Display searched tasks here -->
    <?php include 'display_searched_tasks.php'; ?>
